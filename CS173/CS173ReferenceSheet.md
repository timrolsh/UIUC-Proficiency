...
**Combinations With Repetition**: (fill a box of m cupcakes with n possible cupcakes where $n < m$): $\left(m + n - 1\right) c h \infty s e \left(n - 1\right)$
...
Map ${\mathbb{N}}^{2} \to \mathbb{N} : F \left(A , B\right) = {2}^{A} {3}^{B}$
